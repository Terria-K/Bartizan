...
namespace TowerFall
{
  public class patch_SteelHat : SteelHat
  {
    public patch_SteelHat (ArcherData archerData, Allegiance allegiance, Vector2 position, bool flipped, Arrow arrow, int ownerIndex)

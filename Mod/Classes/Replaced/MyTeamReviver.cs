...
/**
 * I tried to patch this with MonoMod and got:
 *
 * System.MissingMethodException: Method not found: 'TowerFall.TeamReviver.orig_ctor'.
 *
...
namespace TowerFall
{
  public class MyTeamReviver : LevelEntity
  {
    ...
    {
      if (!this.Finished && (!base.Level.Ending || this.ghostRevives) && !this.Corpse.PrismHit && this.Mode != TeamReviver.Modes.Quest) {
